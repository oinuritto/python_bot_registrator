...
class SubjectStudent(Base):
    ...
    __table_args__ = (
        UniqueConstraint('subject_id', 'student_id', name='unique_subject_student'),
    )
    
    # Связи
    subject: Mapped["Subject"] = relationship(back_populates="subject_students")
    student: Mapped["Student"] = relationship(back_populates="subject_students")
