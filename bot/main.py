...
from bot.handlers.stats import get_stats_conversation_handler
...
def main() -> None:
    ...
    # Регистрируем ConversationHandler для дисциплин, студентов, посещаемости, экспорта и статистики
    ...
    application.add_handler(get_stats_conversation_handler())
